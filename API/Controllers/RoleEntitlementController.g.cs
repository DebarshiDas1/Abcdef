...
using Abcdef.Data;
using Abcdef.Filter;
using Abcdef.Entities;
using Abcdef.Authorization;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.JsonPatch;
using System.Linq.Expressions;

namespace Abcdef.Controllers
{
    /// <summary>
    ...
    {
        private readonly AbcdefContext _context;

        public RoleEntitlementController(AbcdefContext context)
        {
            _context = context;
        }
