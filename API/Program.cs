...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Abcdef", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<AbcdefContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Abcdef API v1");
